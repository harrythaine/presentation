...
#variable "VPC_Cidr" {}                          
#variable "VPC_Name" {}                          
#variable "VPC_Cidr_lon_pub_az1" {}             
#variable "VPC_Cidr_lon_pub_SN_az1_Name" {}     
#variable "VPC_Cidr_lon_pub_az2" {}             
#variable "VPC_Cidr_lon_pub_SN_az2_Name" {}   
#variable "VPC_Cidr_lon_priv_az1" {}  
#variable "VPC_Cidr_lon_priv_SN_az1_Name" {}     
#variable "VPC_Cidr_lon_priv_az2" {}             
#variable "VPC_Cidr_lon_priv_SN_az2_Name" {}    
